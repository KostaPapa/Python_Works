#!C:\Users\kpapa01\Desktop\Python\hw\hw05-EXTRA.exe
...
ID number: 0412768
Username: kpapa01
Required FileName: hw05-EXTRA.py
...
def getPlayersThreeGueses():
    ...
    print ((str(guessList[0])) * 7) + (' ' * 2) + ((str(guessList[1])) * 7) + (' ' * 2) + ((str(guessList[2])) * 7)
    print (str(guessList[0])) + (' ' * 5) + (str(guessList[0])) + (' ' * 2) + (str(guessList[1])) + (' ' * 5) + (str(guessList[1])) + (' ' * 2) + (str(guessList[2])) + (' ' * 5) + (str(guessList[2]))
    print (str(guessList[0])) + (' ' * 2) + (str(guessList[0])) + (' ' * 2) + (str(guessList[0])) + (' ' * 2) + (str(guessList[1])) + (' ' * 2) + (str(guessList[1])) + (' ' * 2) + (str(guessList[1])) + (' ' * 2) + (str(guessList[2])) + (' ' * 2) + (str(guessList[2])) + (' ' * 2) + (str(guessList[2]))
    print (str(guessList[0])) + (' ' * 5) + (str(guessList[0])) + (' ' * 2) + (str(guessList[1])) + (' ' * 5) + (str(guessList[1])) + (' ' * 2) + (str(guessList[2])) + (' ' * 5) + (str(guessList[2]))
    print ((str(guessList[0])) * 7) + (' ' * 2) + ((str(guessList[1])) * 7) + (' ' * 2) + ((str(guessList[2])) * 7)
...
def threeRandomDigits():
    ...
    print ((str(randomList[0])) * 7) + (' ' * 2) + ((str(randomList[1])) * 7) + (' ' * 2) + ((str(randomList[2])) * 7)
    print (str(randomList[0])) + (' ' * 5) + (str(randomList[0])) + (' ' * 2) + (str(randomList[1])) + (' ' * 5) + (str(randomList[1])) + (' ' * 2) + (str(randomList[2])) + (' ' * 5) + (str(randomList[2]))
    print (str(randomList[0])) + (' ' * 2) + (str(randomList[0])) + (' ' * 2) + (str(randomList[0])) + (' ' * 2) + (str(randomList[1])) + (' ' * 2) + (str(randomList[1])) + (' ' * 2) + (str(randomList[1])) + (' ' * 2) + (str(randomList[2])) + (' ' * 2) + (str(randomList[2])) + (' ' * 2) + (str(randomList[2]))
    print (str(randomList[0])) + (' ' * 5) + (str(randomList[0])) + (' ' * 2) + (str(randomList[1])) + (' ' * 5) + (str(randomList[1])) + (' ' * 2) + (str(randomList[2])) + (' ' * 5) + (str(randomList[2]))
    print ((str(randomList[0])) * 7) + (' ' * 2) + ((str(randomList[1])) * 7) + (' ' * 2) + ((str(randomList[2])) * 7)
...
def houseSpecialBonusTriangle():
    ...
    for bonus in range(1, 8, 1):
        print ("BONUS " * (bonus-1))        
    print ("BONUS " * (random.randint(MIN_RANDOM_SPECIAL_LINE,MIN_RANDOM_SPECIAL_LINE) - 2)) + "MOMUS " + "BONUS"
